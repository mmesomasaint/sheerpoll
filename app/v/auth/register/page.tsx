...
export default function Register() {
  ...
  const setPassword = (password: string) => (setForm(prev => ({...form, password})))
  const setVerifyPassword = (verifyPassword: string) => (setForm(prev => ({...form, verifyPassword})))
  ...
  return (
    <form onSubmit={submit}>
      <div className="flex flex-col gap-5">
        ...
        <button type="submit" className="px-7 py-3 text-white bg-primary rounded-md shadow-sm">
          Register
        </button>
